...
class Weather_Evaluation:
    ...
    def load_recorded_daily_weather(self, city):
        ...
        if len(rec_data_list[0]['curr_day']) == 0:
            rec_data_list[0]['curr_day'] = "Today's weather not recorded !! Please search and record to preform evaluation"
...
#s = Weather_Evaluation(1)
#print(s.load_recorded_daily_weather('Pune'))
